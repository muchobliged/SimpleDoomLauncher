  ...
  case lan:
    of 1:
      trans = Translation(
        ...
        makeexecportable: "Запускать порт в портативном режиме:",
        ...
        addzdlconfig: "Добавить ZDL конфиг",
      ...
      trans = Translation(
        ...
        makeexecportable: "Try to make ports execs portable:",
